...
# 크리에이터 회원가입/로그인 (라이브클래스 랜딩)
STAGING_LANDING_URL=https://your-staging-url.com

# 고객사 사이트 URL (수강생 회원가입/로그인)
# 변수명 규칙: E=이메일인증, P=휴대폰인증, K=카카오싱크 / 1=ON, 0=OFF
STAGING_SITE_URL_E1P1K1=https://...   # 이메일 ON  | 휴대폰 ON  | 카카오 ON
STAGING_SITE_URL_E1P1K0=https://...   # 이메일 ON  | 휴대폰 ON  | 카카오 OFF
STAGING_SITE_URL_E1P0K1=https://...   # 이메일 ON  | 휴대폰 OFF | 카카오 ON
STAGING_SITE_URL_E1P0K0=https://...   # 이메일 ON  | 휴대폰 OFF | 카카오 OFF
STAGING_SITE_URL_E0P1K1=https://...   # 이메일 OFF | 휴대폰 ON  | 카카오 ON
STAGING_SITE_URL_E0P1K0=https://...   # 이메일 OFF | 휴대폰 ON  | 카카오 OFF
STAGING_SITE_URL_E0P0K1=https://...   # 이메일 OFF | 휴대폰 OFF | 카카오 ON
STAGING_SITE_URL_E0P0K0=https://...   # 이메일 OFF | 휴대폰 OFF | 카카오 OFF
...
| Name | Value |
|------|-------|
| `STAGING_LANDING_URL` | 크리에이터 회원가입/로그인용 랜딩 URL |
| `STAGING_SITE_URL_E1P1K1` | 고객사 사이트 (이메일 ON \| 휴대폰 ON \| 카카오 ON) |
| `STAGING_SITE_URL_E1P1K0` | 고객사 사이트 (이메일 ON \| 휴대폰 ON \| 카카오 OFF) |
| `STAGING_SITE_URL_E1P0K1` | 고객사 사이트 (이메일 ON \| 휴대폰 OFF \| 카카오 ON) |
| `STAGING_SITE_URL_E1P0K0` | 고객사 사이트 (이메일 ON \| 휴대폰 OFF \| 카카오 OFF) |
| `STAGING_SITE_URL_E0P1K1` | 고객사 사이트 (이메일 OFF \| 휴대폰 ON \| 카카오 ON) |
| `STAGING_SITE_URL_E0P1K0` | 고객사 사이트 (이메일 OFF \| 휴대폰 ON \| 카카오 OFF) |
| `STAGING_SITE_URL_E0P0K1` | 고객사 사이트 (이메일 OFF \| 휴대폰 OFF \| 카카오 ON) |
| `STAGING_SITE_URL_E0P0K0` | 고객사 사이트 (이메일 OFF \| 휴대폰 OFF \| 카카오 OFF) |
